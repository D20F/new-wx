<template>
    <view class="home">
        ...
        <view class="features">
            <view @click="jumpRouter('/pages/throughCar/through')">
            ...
            <view @click="jumpRouter('/pages/carHire/index')">
        ...
        <view class="attractions">
            <view class="title">
                <text>美食打卡</text>
                <text @click="jumpRouter('/pages/delicacy/list')">更多>></text>
            </view>
            <view class="scenery">
                <view
                    class="item"
    ...
    methods: {
        ...
        swiper_callback(i) {
            ...
            switch (this.swiper_list[i].type) {
                case 1:
                    this.jumpRouter("/pages/home/kashgar/index", 1);
                    break;
                case 2:
