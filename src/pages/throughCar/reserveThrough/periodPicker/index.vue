...
<script>
import { getComboPage  } from "@/api/api_mapi";
                ...
                foreignId: 4,
                    ...
                    if (res.status == 200) {
                        ...
                        for (const item of res.data) {
                            arr.push(item.boardingTime.split(':')[0] < 10 ? item.boardingTime.split(':')[0].split('')[1] : item.boardingTime.split(':')[0]);
                        }
                        // this.hours = this.generateArray(0, 23);
                        this.hours = [... new Set(arr)];
