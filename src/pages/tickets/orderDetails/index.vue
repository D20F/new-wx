<template>
    <view class="view">
        <view class="title">
            <image :src="form.coverUrl" mode="" />
            <text class="address">{{ form.name }}</text>
            <view>
                <text
                    >开放时间：{{ form.startTime + " ~ " + form.endTime }}</text
                >
        ...
        <view class="formBox">
            <u-form :model="form" ref="uForm">
                ...
                <u-form-item label="使用时段:" label-width="150">
                    <u-input
                        :disabled="true"
                        input-align="left"
                        placeholder=""
        ...
        <view class="btn">
            ...
            <view v-else-if="form.status == 3" class="complete">
                ...
                <view @click="jumpRouter('/pages/tickets/comment/index', form)">
                    <text> 去评价 </text>
                </view>
            </view>
...
export default {
    ...
    methods: {
        ...
        againOrder() {
            this.jumpRouter("/pages/tickets/reserveTickets/index", this.form);
        },
        confirm() {
            uni.showModal({
                title: "验证码",
